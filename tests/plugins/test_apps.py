...
import pytest
from EchoBase.plugins import apps
...
@patch(
    "EchoBase.plugins.apps.find_app", return_value=("flatpak", "org.mozilla.firefox")
)
...
@patch("EchoBase.plugins.apps.find_app", return_value=("local", "nautilus"))
...
@patch("EchoBase.plugins.apps.find_app", return_value=(None, None))
...
@patch("EchoBase.plugins.apps.launch_app", return_value=True)
@pytest.mark.parametrize(
    ["command", "app_name"],
    [
...
@patch("EchoBase.plugins.apps.launch_app", return_value=False)
@pytest.mark.parametrize(
    ["command", "app_name"],
    [
        ["open firefox", "firefox"],
...
@patch("EchoBase.plugins.apps.close_app")
@pytest.mark.parametrize(
    ["command", "app_name"],
    [
