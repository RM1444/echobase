...
import pytest
from EchoBase.plugins import files
...
@patch(
    "EchoBase.plugins.files.os.path.expanduser", return_value="/home/user/Documents"
)
...
@patch("EchoBase.plugins.files.open_folder", return_value=True)
...
@patch("EchoBase.plugins.files.open_folder", return_value=False)
...
@patch("EchoBase.plugins.files.open_folder")
