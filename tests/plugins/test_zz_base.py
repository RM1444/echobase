...
import pytest
from EchoBase.plugins import zz_base
...
@patch("EchoBase.plugins.zz_base.phrases.farewell", return_value="Goodbye.")
def test_handle_exit_commands(mock_farewell, mock_core, command, expected_return):
...
@patch("EchoBase.plugins.zz_base.phrases.farewell", return_value="Goodbye.")
def test_handle_exit_commands_with_prefix(
    mock_farewell, mock_core, command, expected_return
):
